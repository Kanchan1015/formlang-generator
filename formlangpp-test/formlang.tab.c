...
{
  "$end", "error", "$undefined", "TEXT", "NAME", "REQUIRED", "PATTERN",
  "$accept", "form", "field_line", "opt_required", "opt_pattern", YY_NULLPTR
};
#endif
...
#line 1304 "formlang.tab.c"
    break;

  case 4:
#line 29 "formlang.y"
                      { required = 0; }
#line 1310 "formlang.tab.c"
    break;

  case 5:
#line 30 "formlang.y"
                      { /* already set */ }
#line 1316 "formlang.tab.c"
    break;

  case 6:
#line 34 "formlang.y"
                      { pattern[0] = '\0'; }
#line 1322 "formlang.tab.c"
    break;

  case 7:
#line 35 "formlang.y"
                      { /* already set */ }
#line 1328 "formlang.tab.c"
    break;


#line 1332 "formlang.tab.c"
